...
% Header/Footer setup for subsequent pages
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{Code No. 30/2}
\fancyfoot[C]{\thepage}
...
% ==========================================
% PAGE 1: COVER PAGE AND INSTRUCTIONS
% ==========================================
\thispagestyle{empty} % No header/footer on first page

% --- Top Section: Logo and Student Info ---
\noindent
...
\begin{minipage}[t]{0.4\textwidth}
    ...
    \begin{flushright}
        \textbf{Name:} sivaram \\
        \textbf{ID:} cometfwc039 \\
        \textbf{Date of joining:} 20/01/2026
    \end{flushright}
\end{minipage}
...
% --- Title ---
\begin{center}
    \textbf{\Large SUMMATIVE ASSESSMENT - II} \\
    \vspace{0.2cm}
...
\begin{enumerate}
    ...
    \item Section A contains \textbf{4} questions of \textbf{1} mark each. Section B contains \textbf{6} questions of \textbf{2} marks each. Section C contains \textbf{10} questions of \textbf{3} marks each and Section D contains \textbf{11} questions of \textbf{4} marks each.
...
% SECTION B
\section*{SECTION -- B}
\noindent \textit{Question numbers 5 to 10 carry 2 marks each.}
...
% SECTION C
\section*{SECTION -- C}
\noindent \textit{Question numbers 11 to 20 carry 3 marks each.}
...
% SECTION D
\section*{SECTION -- D}
\noindent \textit{Question numbers 21 to 31 carry 4 marks each.}
